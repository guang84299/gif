   ...
   <div class="col-sm-2">
    ...
    <div class="form-horizontal" role="form">
		...
		<div class="form-group">
	        ...
	        <div class="col-sm-6">
			    ...
			    <c:forEach items="${tags}" var="val">
			      <option data-tagid="${val.id }" <c:if test="${article.tagId  == val.id }">selected="selected"</c:if>>${val.name }</option>
			     </c:forEach>
			    </select>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
			 <img src="${article.picPath }" id="img-upload">
...
$(document).ready(function() {  
  ...
  $(".save").click(function(){
    ...
    var article = {};
    article.id = $("[name='title']").attr("title");
